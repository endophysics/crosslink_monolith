...
pub(crate) fn viz_gui_draw_the_stuff_for_the_things(viz_state: &mut VizState, ui: &ui::Context, draw_ctx: &DrawCtx, dt: f32, input_ctx: &InputCtx) {
    {
    ...
    if ui.clicked_id == ui::Id::default() && input_ctx.mouse_held(MouseButton::Left) {
