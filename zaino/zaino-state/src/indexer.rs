...
use zaino_proto::proto::{
    ...
    service::{
        ...
        Duration, Exclude, FaucetRequest, FaucetResponse, GetAddressUtxosArg, GetAddressUtxosReplyList, GetSubtreeRootsArg,
...
pub trait LightWalletIndexer: Send + Sync + Clone + ZcashIndexer + 'static {
    ...
    /// Request a donation from the faucet
    async fn request_faucet_donation(
        &self,
        request: FaucetRequest,
    ) -> Result<FaucetResponse, Self::Error>;
